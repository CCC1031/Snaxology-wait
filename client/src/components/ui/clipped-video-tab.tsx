...
const items = [
  ...
  },
  {
    ...
    description: "Automation-first AI systems with human validation and scalable workflows.",
  ...
  },
  {
    ...
    title: "Data Engine",
    description: "Transparent AI models with interpretable predictions and decision-making insights.",
  ...
  return (
    <div className="relative overflow-hidden w-full">
      ...
      <div className="absolute left-4 bottom-16 z-20">
        <div className="bg-white rounded-[28px] shadow-xl border border-[#e8e8e8] p-3 w-[200px]">
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    ${activeTab === index
                      ? "bg-[#fff0f0] border-[#E31E24]"
                      : "border-transparent hover:border-[#E31E24] hover:bg-[#fff5f5]"
                    }
                  `}
                >
                  <Icon
                    className={`w-4 h-4 transition-colors duration-300 ${
                      activeTab === index ? "text-[#E31E24]" : "text-[#131313] group-hover:text-[#E31E24]"
                    }`}
                  />
                  <span
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-[11px] bg-[#fff0f0] text-[#E31E24] px-2 py-1 rounded-md">
                ...
                {activeItem.card.tasks.map((task, index) => (
                  <div key={index} className="flex items-start gap-2">
                    <div className="mt-[2px]">
                      {task.status === "completed" && <CheckCircle2 className="w-4 h-4 text-[#E31E24]" />}
                      {task.status === "progress" && <LoaderCircle className="w-4 h-4 text-[#E31E24] animate-spin" />}
